...
const BannerContainer = ({ children, backgroundImageSrc, customBoxStyles }: {
  ...
  return (
    <Box
      ...
      style={{ height: '600px', textAlign: 'left', ...customBoxStyles }}>
...
const VPNBanner = () => (
  <BannerContainer backgroundImageSrc={iitVpnBanner.src} customBoxStyles={{ backgroundPositionX: '20%' }}>
...
const Security2FABanner = () => (
  <BannerContainer backgroundImageSrc={iit2faBanner.src} customBoxStyles={{ backgroundPositionX: '85%' }}>
...
const AccessBanner = () => (
  <BannerContainer backgroundImageSrc={iitAccessBanner.src} customBoxStyles={{ backgroundPositionX: '65%' }}>
    <BannerContentHeading variant={HeadingVariants.Heading1} headingColor={HeadingColors.White}>
