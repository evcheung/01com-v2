...
const TeamCard = styled(Box)`
  ...
  display: flex;
  align-items: center;
  ${breakpoints("flex-direction", "", [{ 1060: "column" }])}
  ${breakpoints("align-items", "", [{ 1060: "flex-start" }])}
  ${breakpoints("padding", "", [{ 1060: "48px" }])}
`;
const StyledHeading2 = styled(Heading)`
  ...
  ${breakpoints("font-size", "", [{ 1060: "32px" }])}
  ${breakpoints("line-height", "", [{ 1060: "32px" }])}
`;
const StyledHeading3 = styled(Heading)`
  ...
  ${breakpoints("line-height", "", [{ 1060: "32px" }])}
  ${breakpoints("font-size", "", [{ 1060: theme.fontSize.xxl }])}
  ${breakpoints("margin-top", "", [{ 1060: "24px" }])}
`;

const ProfileImage = styled(Image)`
  height: auto;
  ${breakpoints("width", "", [{ 1060: "200px" }])}
  ${breakpoints("width", "", [{ 760: "140px" }])}
`;
    ...
    <Layout variant={LayoutVariants.Dark} pageTitle="About Us">
      ...
      <PageContentContainer>
        <StyledText variant={TextVariants.Body1}>
          Technology pioneer of Post-Quantum Cybersecurity and Remote Access
          Software.
        </StyledText>
        ...
        <StyledText variant={TextVariants.Body1}>
          ...
          operate on classical computer systems as we know them today while at
          the same time secure enough to safeguard against potential
          cyberattacks from quantum computers.
        </StyledText>

        <StyledText variant={TextVariants.Body1}>
          The Company provides IronCAP™ cryptographic engine to businesses of
          all sizes, allowing them to easily transform their systems to
          withstand threats from Quantum Computers.
        </StyledText>

        <StyledText variant={TextVariants.Body1}>
          The Company also provides vertical solutions that utilize its own
          IronCAP cryptographic engine to ensure quantum safety. IronCAP X™ is
          the world's first quantum-safe end-to-end email encryption solution.
          It is designed for ultimate email privacy as well as ensuring senders'
          authenticity to eliminate phishing.
        </StyledText>
        ...
        <StyledText variant={TextVariants.Body1}>
          ...
          computers.The Company also provides vertical solutions that utilize
          its own IronCAP cryptographic engine to ensure quantum safety. IronCAP
          X™ is the world's first quantum-safe end-to-end email encryption
          solution. It is designed for ultimate email privacy as well as
          ensuring senders' authenticity to eliminate phishing.
        </StyledText>
      ...
      <Box margin="-24px 0 0 0" flexDirection="column" flexAlignment="center">
        <StyledHeading2 variant={HeadingVariants.Heading1}>
          The Team
        </StyledHeading2>
      </Box>
      <TeamGrid>
        <TeamCard>
          ...
          <Box>
            ...
            <Text variant={TextVariants.Body1}>
              ...
              cyber security solutions development, he also has 12 years
              experience in patent prosecution. Andrew is a co-inventor of 7
              patents plus several patent-pending applications.
            </Text>
          </Box>
        </TeamCard>
        ...
        <TeamCard>
          ...
          <Box>
            ...
            <Text variant={TextVariants.Body1}>
              ...
              experience in managing publicly listed companies, Brian has been
              the CFO of 01 for over 18 years. Prior to joining 01, Brian worked
              as the CFO of various other publicly listed companies. In addition
              to his extensive CFO experience, Brian also has 12 years
              experience in patent prosecution and patent litigation in the US
              and Canada.
            </Text>
          </Box>
        </TeamCard>
        ...
        <TeamCard>
          ...
          <Box>
            ...
            <Text variant={TextVariants.Body1}>
              ...
              positions at Dynasty Components Inc. Mr. Train holds a B.A. degree
              of Economics from the University of Toronto with directorships and
              board experience in various industries including Ozz Utility
              Management, Navlyns, Blumont Capital, etc.
            </Text>
          </Box>
        </TeamCard>
        ...
        <TeamCard>
          ...
          <Box>
            ...
            <Text variant={TextVariants.Body1}>
              Gary has extensive experience working as a lawyer and advisor in
              various industries. He practices in a number of areas of business
              law, including M&A, private equity, venture capital, capital
              markets, and corporate finance. He is a Partner in the Business
              Law and Indigenous Law Practice Groups at Fogler, Rubinoff LLP in
        ...
        <TeamCard>
          ...
          <Box>
            ...
            <Text variant={TextVariants.Body1}>
              ...
              2012 at University of Auckland, New Zealand. <br />
              <br />
              ...
              DAGS reached the conclusive round while the fourth one - HQC was
              selected as the winner in March 2025. Dr. Persichetti has also
              co-authored three submissions to NIST's "onramp" call for novel
              signature schemes.
              <br />
              <br />
              Dr. Persichetti is one of the most acclaimed researchers in
              code-based cryptography. He is frequently being invited to act as
              an advisory committee member for major cryptography conferences
              such as CRYPTO, EUROCRYPT and ASIACRYPT; as well as a
              peer-reviewer for publications like the Journal of Mathematical
              Cryptology and Designs, Codes and Cryptography. He was chair of
              the 2018 edition of the Code-Based Cryptography Workshop (CBC
              2018) and co-chair of the 2019 and 2020 editions. His expertise is
              called upon regularly to speak at events such as the Joint
              Mathematics Meetings (JMM), coding and cryptography by AMS, SIAM
              and DIMACS, workshops on Post-Quantum Cryptography, and many
              others.
            </Text>
          </Box>
        </TeamCard>
