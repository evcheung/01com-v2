    ...
    <IITLayout>
      ...
      <StepsGrid>
        <StepCard>
          ...
          <Box margin="16px 0 0 0">
            <Text variant={TextVariants.Body1}>
              ...
              for a free I'm InTouch account.
            </Text>
          </Box>
        </StepCard>
        <StepCard>
          ...
          <Box margin="16px 0 0 0">
            <Text variant={TextVariants.Body1}>
              ...
              . Login to your I'm InTouch account and download/install the I'm
              InTouch software onto the computer. Follow the simple on-screen
        ...
        <StepCard>
          ...
          <Box margin="16px 0 0 0">
            <Text variant={TextVariants.Body1}>
              To remotely access your I'm InTouch-ready computer, simply go to{" "}
              <Anchor
                href="/imintouch-remote-pc-desktop/"
                target="_blank"
                variant={AnchorVariants.Large}
              ...
              and login to your I'm InTouch account. For speedy access from your
              mobile devices, you can install our free mobile app{" "}
              <Anchor
                href="/imintouch-remote-pc-desktop/go/"
                target="_blank"
                variant={AnchorVariants.Large}
              >
                I'm InTouch Go{" "}
              ...
              or{" "}
              <Anchor
                href="/imintouch-remote-pc-desktop/gomail/"
                target="_blank"
                variant={AnchorVariants.Large}
              >
                I'm InTouch GoMail
