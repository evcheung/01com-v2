      ...
      <PageContentContainer>
        <ContactContainer>
          ...
          <Box>
            ...
            <Anchor
              style={{ marginTop: "0", padding: "0", display: "inline-block" }}
          ...
          <Box>
            <ContactSubText style={{ margin: "0", padding: "0" }}>
              Email:
            </ContactSubText>
            <Anchor
              style={{ marginTop: "0", padding: "0", display: "inline-block" }}
        ...
        <Box margin="48px 0 0 0">
          ...
          <Text variant={TextVariants.Body2}>
            ...
            network with I'm InTouch installed and at least one of them must be
            "on".
          </Text>
        </Box>
      </PageContentContainer>
