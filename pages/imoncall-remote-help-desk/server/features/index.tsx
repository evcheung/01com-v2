...
const ADMINISTRATION_FEATURES = [
  {
    description: "Add/Remove/Edit user accounts of your I'm InTouch remote access system",
    pageRoute: "/imintouch-remote-pc-desktop/server/features/add-remove-accounts",
  },
  {
    description: "Manage Access Rights of user accounts including time-of-accessibility",
...
const GENERAL_FEATURES = [
  {
    description: "Controlling desktop computer as if you were sitting in front of it",
  },
  {
  ...
  {
    description: "Auto-Login/Physical Authentication via the I'm InTouch SecureKEY (optional device)",
  },
  {
      ...
      <FullPageContentContainer>
        <FeaturesGrid>
          ...
          <FeatureCard
            ...
            imgSrc={List.src}
            columns={2}
            subText={<Text style={{ marginBottom: '24px', fontSize: '18px', lineHeight: '24px' }}>Click to <StyledLink href="/imintouch-remote-pc-desktop/features/" target="_blank">Learn More</StyledLink> from www.imintouch.com</Text>}
          >
            {width > 1200
