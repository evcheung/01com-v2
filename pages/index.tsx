...
const FeaturedNewsHeadingContainer = styled(Box)`
  ...
  ${breakpoints("margin", "", [{ 1280: "96px 0px 20px 0px" }])}
  ${breakpoints("margin", "", [{ 760: "32px auto 0px auto" }])}
`;
const FeaturedNewsHeading = styled(Heading)`
  &&& {
    font-size: 36px;
    ${breakpoints("font-size", "", [{ 1180: "32px" }])}
`;

const MainBannerContainer = styled(Box)`
  margin: 48px 0;
  ${breakpoints("margin", "", [{ 1280: "0" }])}
`;

const NewsContainer = styled(Box)`
  margin: -28px 0px 96px 0px;

  ${breakpoints("margin", "", [{ 760: "0px 0px 48px 0px" }])}
`;
      ...
      <NewsContainer width="100%" flexDirection="column" flexAlignment="center">
        {width > 760 ? (
          <>
            ...
            >
              <FeaturedNewsHeading variant={HeadingVariants.Heading1}>
                Featured News
              </FeaturedNewsHeading>
        ...
        {width > 760 ? (
          <LatestNewsContainer currentItems={featuredNewsItems} />
        ) : (
          <LatestNewsContainerMobile currentItems={featuredNewsItems} />
        )}
