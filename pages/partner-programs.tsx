  ...
  return (
    <Layout variant={LayoutVariants.Dark} pageTitle="Partner Programs">
      ...
      <PageContentContainer>
        ...
        <Text variant={TextVariants.Body1}>Our products and special private labelling programs are designed to assist OEMs in meeting their business goals, differentiating their products, build their brand and providing a total solution to their customers.</Text>
        <Box margin="12px 0 88px 0">
          <Text variant={TextVariants.Body1}>To learn more about our IBP, SI, or OEM programs please contact us at toll-free (800) 668-2185 or (905) 795-2888 or email to <StyledLink href="mailto:sales@01com.com">sales@01com.com</StyledLink>.</Text>
        </Box>
      </PageContentContainer>
    </Layout>
  )
