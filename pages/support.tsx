...
const StyledContactContainer = styled(Box)`
  ...
  ${breakpoints("margin", "", [{ 800: "0" }])}

  ${breakpoints("height", "", [{ 800: "auto" }])}
`;
...
const InfoColumnGrid = styled(Box)`
  ...
  ${breakpoints("margin-top", "", [{ 800: "32px" }])}
  ${breakpoints("padding", "", [{ 800: "0" }])}
  ${breakpoints("grid-template-columns", "", [{ 800: "1fr" }])}
  ${breakpoints("grid-gap", "", [{ 800: "32px" }])}
`;
    ...
    <Layout variant={LayoutVariants.Dark} pageTitle="General Support">
      ...
      <PageContentContainer>
        <StyledText variant={TextVariants.Body1}>
          ...
          or have questions regarding pricing or features of our remote access
          and remote control software, we are available at your convenience.
        </StyledText>
          ...
          <ContactsRowGrid>
            ...
            <ContactContainer heading="Phone" id="phone">
              ...
              >
                ...
                <Box
                  style={{
                    borderRight: `1px dotted ${theme.colors.neutral.md}`,
                    height: "46px",
                  }}
                ></Box>
                <Box>
