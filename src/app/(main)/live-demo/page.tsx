...
export default function LiveDemo() {
  return (
    ...
    >
      {/* ─── Page Title ─── */}
      <Titles text={<>IronCAP<sup className="text-[18px] md:text-[30px] align-super leading-none">™</sup> Live Demo</>} />    
          ...
          <div className="px-6 md:px-[95px] pb-16 flex flex-col md:flex-row gap-12 items-start">
            ...
            <div className="w-full md:w-[479px] shrink-0 flex flex-col gap-6">
              ...
              <div>
                ...
                <ul className="text-steel-gray text-[15px] leading-[24px] flex flex-col gap-3 list-disc list-inside">
