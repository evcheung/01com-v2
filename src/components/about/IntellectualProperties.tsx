...
export function IntellectualProperties() {
  return (
      ...
      <div className="max-w-[1512px] mx-auto px-6 sm:px-8 lg:px-10 xl:px-[95px]">
        <div className="max-w-[1230px] space-y-8">
          <p className="text-steel-gray text-[15px] leading-[24px]">
            ...
            patents. Established in 1992, 01 Quantum is always at the forefront
            of technology. Its latest innovation is on cybersecurity with the
            development focus on Post-Quantum Cryptography (PQC). 01&apos;s PQC
            algorithms are designed to operate on classical computer systems as
            we know them today while at the same time secure enough to safeguard
          ...
          <div className="rounded-[20px] border border-lite-gray/60 bg-white px-6 py-7 sm:px-8">
            <h2 className="text-quantum-green text-[20px] font-medium leading-[28px] mb-6">
              Patents
            </h2>
