...
export const xMailSectionItems = [
  ...
  { label: "Why XMail?", href: "/products/ironcap-xmail/why-xmail" },
  {
    ...
    href: "/products/ironcap-xmail/pricing-and-comparison",
  },
];

const MAIN_PAGE_HREF = "/products/ironcap-xmail";
...
export function XMailSectionChrome({
  children,
}: {
      ...
      {showBackArrow && (
        <section className="bg-white py-5">
          <div className="px-4 sm:px-5 lg:px-6">
            <Link
              href={MAIN_PAGE_HREF}
              aria-label="Back to IronCAP XMail"
...
export default XMailSectionChrome;
